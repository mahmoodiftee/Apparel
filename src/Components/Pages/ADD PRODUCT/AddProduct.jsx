          ...
          <form onSubmit={handleAddProduct} className="card-body">
            <div className='flex flex-col lg:flex-row justify-between gap-6'>
              ...
              <div className="form-control">
                ...
                <select name="brand" className="select border-none text-[#9ca3af] font-medium p-2 rounded-lg bg-base-200 input-bordered w-full lg:w-[400px] pr-16">
            ...
            <div className='flex flex-col lg:flex-row justify-between gap-6'>
              <div class="form-control">
                ...
                <select name="productType" className="select border-none text-[#9ca3af] font-medium p-2 rounded-lg bg-base-200 input-bordered w-full lg:w-[400px] pr-16">
                  <option disabled selected>Pick one</option>
